...
void SetCustomStyles() {
    ...
    style.Colors[ImGuiCol_Text] = ImVec4(0.866f, 0.866f, 0.866f, 1.0f); // #ddd
    style.Colors[ImGuiCol_WindowBg] = ImVec4(0.117f, 0.117f, 0.117f, 1.0f); // #1e1e1e
    style.Colors[ImGuiCol_Border] = ImVec4(0.266f, 0.266f, 0.266f, 1.0f); // #444
    style.Colors[ImGuiCol_FrameBg] = ImVec4(0.164f, 0.164f, 0.164f, 1.0f); // #2a2a2a
    style.Colors[ImGuiCol_Button] = ImVec4(0.628f, 0.121f, 0.286f, 1.0f); // #a01f49
    style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.8f, 0.0f, 0.0f, 1.0f); // #cc0000
    style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.6f, 0.0f, 0.0f, 1.0f); // #990000
